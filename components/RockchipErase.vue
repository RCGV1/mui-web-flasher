...
const bundledLoader = ref(publicPath('/rockchip/rk3506_spl_loader_v1.06.112.bin'))
const bundledOptions = [
  { value: publicPath('/rockchip/rk3506_spl_loader_v1.06.112.bin'), label: 'RK3506G2 official rkbin v1.06.112 (Lyra, Lyra W, Lyra Plus)' },
  { value: publicPath('/rockchip/rk3506b_spl_loader_v1.06.112.bin'), label: 'RK3506B official rkbin v1.06.112 (Lyra Zero W, Lyra Ultra)' },
  { value: publicPath('/rockchip/rk3506_spl_loader.bin'), label: 'RK3506G2 minimal (bundled fallback)' },
  { value: publicPath('/rockchip/rk3506b_spl_loader.bin'), label: 'RK3506B minimal (bundled fallback)' },
]
